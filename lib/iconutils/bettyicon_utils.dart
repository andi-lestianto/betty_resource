class BettyIcon {
  ...
  static const String icReserve2Svg = '${path}assets/icon/ic-reserve2.svg';
  ...
  static const String icAddSquareBulkSvg =
      '${path}assets/icon/ic-add-square-bulk.svg';
  static const String icMinusSquareBulkSvg =
  ...
  static const String icEmptyWalletSvg =
      '${path}assets/icon/ic-empty-wallet.svg';
